                    ...
                    <div class="section-list__item-info">
                        <div>
                            ...
                            <div class="section-list__item-info-data">
                                <img class="heart-icon" src="./src/images/icons/heart.svg" alt="Heart icon" />
                                <p>128</p>
                                <img class="comment-icon" src="./src/images/icons/comment.svg" alt="Comment icon" />
                                <p>31</p>
                            </div>
                        </div>
                        <div>
                        ...
                        <div>
                            <p class="section-list__item-name image-upload">Image upload</p>
                            <p>11-04-2016</p>
                        </div>
                    </div>
                </div>
